...
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        yield mongoose_1.default.connect(`mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@todocluster.kf4x7.mongodb.net/managementApp?retryWrites=true&w=majority`);
