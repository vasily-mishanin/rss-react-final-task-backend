...
exports.clearUserInTasks =
  exports.deleteTaskByParams =
...
const createTask = (params, guid, initUser, emit = true, notify = true) =>
...
const updateTask = (id, params, guid, initUser, emit = true, notify = true) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteTaskById = (taskId, guid, initUser, emit = true, notify = true) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const deleteTaskByParams = (params, guid, initUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const clearUserInTasks = (userId, guid, initUser) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    for (const onTask of tasks) {
      ...
      if (userIndex > 0) {
        ...
        clearedTasks.push(
          yield (0, exports.updateTask)(onTask._id, { users: onTask.users }, guid, initUser, false)
        );
      }
    }
    server_service_1.socket.emit('tasks', {
